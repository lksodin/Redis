...
class Yampee_Redis_Client
{
  ...
  /**
   * Add a value on the left of a list.
   *
   * @param $listName
   * @param $value
   * @return mixed
   */
  public function lPush($listName, $value)
  {
    return $this->send('lpush', array($listName, $value));
  }

  /**
   * Add a value on the right of a list.
   *
   * @param $listName
   * @param $value
   * @return mixed
  ...
  {
    return $this->send('rpush', array($listName, $value));
  }
  ...
  {
    return $this->send('lpop', array($listName));
  }
   ...
   * @return mixed
   */
  public function listPop($listName)
  {
    return $this->send( 'rpop', array($listName));
  }
